...
public class UserControllerTest {
    ...
    public void testRegisterUser() throws Exception {
        String requestBody = "{\"firstName\": \"Premchand\",\"lastName\": \"jannaram\",\"email\": \"premchand@gmail.com\",\"password\": \"password\",\"role\": \"USER\"}";

        User user = new User();
        user.setId(1);
        user.setFirstName("Premchand");
        user.setLastName("jannaram");
        user.setEmail("premchand@gmail.com");
        ...
        mockMvc.perform(post("/users/register")
            ...
            .andExpect(jsonPath("$.firstName").value("Premchand"))
            .andExpect(jsonPath("$.lastName").value("jannaram"))
            .andExpect(jsonPath("$.email").value("premchand@gmail.com"))
    ...
    public void testLoginUser() throws Exception {
        String requestBody = "{\"email\": \"premchand@gmail.com\",\"password\": \"password\"}";
