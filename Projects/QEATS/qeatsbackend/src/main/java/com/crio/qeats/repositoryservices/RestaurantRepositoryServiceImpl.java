...
public class RestaurantRepositoryServiceImpl implements RestaurantRepositoryService {
  ...
  public List<Restaurant> findAllRestaurantsCloseBy(Double latitude, Double longitude,
      LocalTime currentTime, Double servingRadiusInKms) throws NullPointerException {
    ...
    for (Restaurant res : restaurants) {
      ...
      double distanceKm =
          GeoUtils.findDistanceInKm(latitude, longitude, restaurantLat, restaurantLon);
  ...
  private boolean isValidTime(LocalTime current, LocalTime open, LocalTime close) {
