...
public class PassengerTypeCount implements Comparable<PassengerTypeCount> {
    ...
    public int compareTo(PassengerTypeCount other) {
        ...
        else if (this.count == other.count) return this.passengerType.compareTo(other.passengerType);
        else return -1;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return passengerType.equals(other.passengerType) && count == other.count;
    }
}
